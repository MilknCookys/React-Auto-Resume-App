export default function ResumeMainForm({
  mainInformation,
  handleMainInfo,
  isActive,
  changeActiveForm,
      ...
      <section>
        ...
        <div className="inputSection">
          ...
          <input
            type="text"
            id="schoolStartDate"
            value={mainInformation.schoolStartDate}
            onChange={handleMainInfo}
          />
        </div>
        <div className="inputSection">
          ...
          <input
            type="text"
            id="schoolEndDate"
            value={mainInformation.schoolEndDate}
            onChange={handleMainInfo}
          />
        </div>
      </section>
