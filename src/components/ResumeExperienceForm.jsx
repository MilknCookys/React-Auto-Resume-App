import ExperienceFormDropDown from "./ExperienceFormDropDown";
import ExperienceFormDropDownContent from "./ExperienceFormDropDownContent";
...
export default function ResumeExperienceForm({
  ...
  return (
    <ExperienceFormDropDown
      ...
      DropDownContent={ExperienceFormDropDownContent}
